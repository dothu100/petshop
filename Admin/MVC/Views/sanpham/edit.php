...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=sanpham&act=update" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="">Giống</label>
            <input type="text" class="form-control" id="" placeholder="" name="Giong" value="<?=$data['Giong']?>">
        </div>
        <div class="form-group">
            <label for="">Màu</label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="" name="GioiTinh" value="<?=$data['GioiTinh']?>">
        </div>
        <div class="form-group">
            <label for="">Tuổi</label>
            <input type="text" class="form-control" id="" placeholder="" name="Tuoi" value="<?=$data['Tuoi']?>">
        </div>
        <div class="form-group">
            <label for="">Nguồn gốc</label>
            <input type="text" class="form-control" id="" placeholder="" name="NguonGoc" value="<?=$data['NguonGoc']?>">
        </div>
