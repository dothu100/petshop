                            ...
                            <div class="footer-text">
                                <ul>
                                    <li>
                                        ...
                                        <p>470 Trần Đại Nghĩa, Hòa Quý, Ngũ Hành Sơn</p>
                                        <p>Trường ĐH Công nghệ thông tin và Truyền thông Việt-Hàn - ĐHĐN</p>
                                    </li>
                                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>&copy; DT_PETSHOP 2023. All Rights Reserved.</p>
                </div>
